...
def test_change_state_to_received(factories):
    smart_deposit = factories.SmartDepositFactory(state=SMART_DEPOSIT_STATUS_WAITING, coast=50, amount=50)
...
def test_change_state_to_received_no_amount(factories):
    smart_deposit = factories.SmartDepositFactory(state=SMART_DEPOSIT_STATUS_WAITING, coast=50)
...
def test_change_state_to_received_small_amount(factories):
    smart_deposit = factories.SmartDepositFactory(state=SMART_DEPOSIT_STATUS_WAITING, coast=50, amount=40)
